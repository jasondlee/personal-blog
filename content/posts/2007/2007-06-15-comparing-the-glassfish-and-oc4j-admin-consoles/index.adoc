...
image::oc4j_admin_console_front.png[]
...
image::glassfish_admin_console_front.png[]
...
image::oc4j_admin_console_applications.png[]

Deploying an application is done by clicking on the deploy button, and following the wizard.

Archive selection:

image::oc4j_admin_console_deploy1.png[]

Application attributes entry:

image::oc4j_admin_console_deploy2.png[]

Deployment settings:

image::oc4j_admin_console_deploy3.png[]

Results:

image::oc4j_admin_console_deploy4.png[]
...
image::glassfish_admin_console_applications.png[]
...
image::glassfish_admin_console_deploy1.png[]
...
image::oc4j_admin_console_perf1.png[]
...
image::oc4j_admin_console_perf2.png[]

image::oc4j_admin_console_perf3.png[]
...
image::glassfish_admin_console_perf1.png[]

image::glassfish_admin_console_perf2.png[]
...
image::glassfish_admin_console_perf3.png[]
...
image::oc4j_admin_console_jta1.png[]

image::glassfish_admin_console_jta1.png[]

OC4J goes a step further though, giving a nice performance overview of historical JTA information:

image::oc4j_admin_console_jta2.png[]
