...
image:/2017/my-book-has-finally-been-published/j9pb.png[Java 9 Programming Blueprints, float="right", style="padding-left:10px; padding-bottom: 10px;" link=https://www.packtpub.com/application-development/java-9-programming-blueprints]
