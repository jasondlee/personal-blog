...
image::systemprefs-300x251.png[link="/images/2012/04/systemprefs.png" title: "'System Preferences'"]

Now uncheck "Automatic Grahpics Switching":

image::graphicsswitching-300x251.png[link="/images/2012/04/graphicsswitching.png" title: "'Graphics Switching Preference'"]
...
image::aboutnetbeans-256x300.png[link="/images/2012/04/aboutnetbeans-256x300.png" title: "'About NetBeans'"]
