...
type: post
link: /:year/:slug
title: Decompose and Data. Let's See What You Got
...
image: https://arkivanov.github.io/Decompose/media/logo/circle-2.png
---
...
And that's basic data-to-screen logic. I breezed over a bit in this for brevity's sake, so be sure you check out the https://github.com/jasondlee/giftbook-demo/tree/DATA[Git repo] for the complete source. In the next few posts, we'll add the ability to create occasions, recipients, etc., and then we'll take a look at dependency injection to see how we can clean up that object instantiation.
