...
image::newenterpriseapp1-300x211.png[class='aligncenter' title: "'New Enterprise Application Step 1', link='newenterpriseapp1.png'"]
...
image::newenterpriseapp2-300x205.png[class='aligncenter' title: "'New Enterprise Application Step 2' , link='newenterpriseapp2.png'"]
...
image::newenterpriseapp3-300x174.png[class='aligncenter' title: "'New Enterprise Application Step 3' , link='newenterpriseapp3.png'"]
...
image::newappclient1-300x211.png[class='aligncenter' title: "'New Application Client Step 1', link='newappclient1.png'"]
...
image::newappclient3-300x174.png[class='aligncenter', title: "'New Application Client Step 3', link='newappclient3.png'"]
...
image::appclient-300x235.png[class='aligncenter' title: "'The running Application Client', link='appclient.png'"]
