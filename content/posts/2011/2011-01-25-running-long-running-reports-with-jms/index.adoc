...
image::connectionfactory-300x197.jpg[link='connectionfactory.jpg' title: "'Connection Factory Creation' width='600'"]

image::destinationresource-300x197.jpg[link='destinationresource.jpg' title: "'Creating the Destination Resource' width='600'"]

And that should do it.  If you're interested in the source, you can find that link:jsfjms.tar.gz[here]. If you have any questions, feel free to post them below.
